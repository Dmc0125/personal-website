...
>
	<header class="min-[500px]:col-[1/3] flex items-center justify-between top-0 w-full h-fit">
		...
		<a
			href={repository}
			class="ml-auto hover:text-sky-500 dark:hover:text-sky-300 text-gray-600 dark:text-slate-500"
			target="_blank"
			rel="noopener noreferrer"
		...
		>
			...
			>
			<p
				class="ml-auto hidden sm:flex items-center gap-x-2 font-medium transition-all url-new-page"
			>
				Github
				<svg
